...
extern int flow_position_control_main(int argc, char *argv[]);
extern int flow_position_estimator_main(int argc, char *argv[]);
extern int flow_speed_control_main(int argc, char *argv[]);
...
extern int md25_main(int argc, char *argv[]);
...
const struct builtin_s g_builtins[] = {
    ...
    {"sysinfo", SCHED_PRIORITY_DEFAULT, 2048, sysinfo_main},
    {"adc", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, adc_main},
    {"ardrone_interface", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, ardrone_interface_main},
    ...
    {"bma180", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, bma180_main},
    ...
    {"eeprom", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, eeprom_main},
    {"esc_calib", SCHED_PRIORITY_DEFAULT, 4096, esc_calib_main},
    {"ets_airspeed", SCHED_PRIORITY_DEFAULT, 2048, ets_airspeed_main},
    {"ex_fixedwing_control", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, ex_fixedwing_control_main},
    {"flow_position_control", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, flow_position_control_main},
    {"flow_position_estimator", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, flow_position_estimator_main},
    {"flow_speed_control", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, flow_speed_control_main},
    ...
    {"md25", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, md25_main},
    ...
    {"px4_simple_app", SCHED_PRIORITY_DEFAULT, CONFIG_PTHREAD_STACK_DEFAULT, px4_simple_app_main},
